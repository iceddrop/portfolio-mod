...
export default function Projects(){
    return(
        <section className='pb-20'>
          <h3  className='text-center project-title font-blinker text-2xl md:text-4xl font-bold'>My Projects</h3>
           <p className='text-center font-poppins mt-3 text-lg font-bold'>These are some of the projects i have worked on.</p>
           <Swiper
        effect={"cards"}
        grabCursor={true}
        modules={[EffectCards]}
